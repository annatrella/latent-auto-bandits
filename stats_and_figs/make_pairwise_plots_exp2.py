...
T = NUM_TIME_STEPS
EXP_ROOT_FOLDER = "../experiment_results/against_baselines/"
OUTPUT_FOLDER = "against_baselines/"
...
def get_all_exp_results(parent_folder):
    ...
    for exp in subfolder:
        ...
        # print(grid_to_latex(grid, agents, f"$k = {k}$, $\sigma_z = {sigma_z}$, $\sigma_r = {sigma_r}$"))
